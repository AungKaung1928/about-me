...
|---------|-------------|------------|--------|
| 🤖 **Pick and Place System** | MoveIt + RViz integration with launch files | ROS2, MoveIt, C++ | 🚧 In Progress |
| 🗺️ **Autonomous Navigation** | Advanced pathfinding and obstacle avoidance | Python, ROS2, SLAM | ✅ Active |
